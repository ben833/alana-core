import { classifier, LoadSavedClassifiers, TopicCollection, Classifiers, Classification, checkUsingClassifier, runThroughClassifiers } from './classifier';
...
export default class NLPBase implements IntentGenerator {
  ...
  constructor(classifierFile: string =  `${__dirname}/../../nlp/classifiers.json`) {
    const allClassifiers = LoadSavedClassifiers(classifierFile);
