...
var Alana = (function () {
    ...
    Alana.prototype._processMessage = function (basicUser, message) {
        ...
        return this.userMiddleware.getUser(basicUser)
            .catch(function (err) {
            var newUser = _.merge(_this.createEmptyUser(), basicUser);
            if (message.type === 'greeting') {
                return _this.userMiddleware.saveUser(newUser);
            }
            var greeting = {
                type: 'greeting',
            };
            return _this.userMiddleware.saveUser(newUser)
                .then(function () { return _this._processMessage(basicUser, greeting); })
