...
var Alana = (function () {
    ...
    Alana.prototype._processMessage = function (basicUser, message) {
        ...
        return this.userMiddleware.getUser(basicUser)
            ...
            user = completeUser;
            response = new outgoing_1.default(_this, user, message.conversation_id);
            return completeUser;
        })
            ...
            return _this._process(user, request, response, 100, true);
        })
            .then(function () {
     ...
     */
    Alana.prototype._process = function (user, request, response, loops, directCall) {
        var _this = this;
        if (loops === void 0) { loops = 100; }
